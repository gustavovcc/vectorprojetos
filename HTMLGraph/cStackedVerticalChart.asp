...
'---------------------------- Calculate the average value for this data set
	...
	Response.Write "<tr><td colspan=""" & (iMax + 4)  & """ class=""chart3_title"">" & m_sChartTitle & "</td></tr>"
...
'---------------------------- Should we print an image for the average bar?
	...
	If Len(m_sDisplayAverageBar) > 0 Then
	    iShrinked1 = m_lngAverage
		If m_lngShrinkFactor > 1 Then iShrinked1 = DataShrink(m_lngAverage, m_lngShrinkFactor)
	    Response.Write "<td valign=""bottom"" class=""chart3_barcell"">" & m_lngAverage & "<br /><img src=""" & _
		        m_sDisplayAverageBar & """ width=""" & m_lngBarImageWidth & """ height=""" & _
		        iShrinked1 & """ alt=""Average"" title=""Average: " & m_lngAverage & """ /></td>"
	Else
    ...
    Select Case m_lngArrayCounter
        Case 2
			For i = 0 To iMax
				...
				Response.Write "<td valign=""bottom"" class=""chart3_barcell"">" & _
				    lngTotal1_2 & "<br /><img src=""" & m_arrBarImages(0) & """ width=""" & m_lngBarImageWidth & """ height=""" & _
...
'---------------------------- Print Totals to the right of the chart?
    ...
    If m_lngTotalsMode = 1 Then
	    ...
	    Select Case m_lngArrayCounter
	        Case 2
			    Response.Write "<td rowspan=""2"" class=""chart3_totals_right"">" & _
				    ...
				    m_lngBarImageWidth & """ height=""" & m_lngBarImageWidth & """ alt=""""  />&nbsp;" & m_arrLegendText(1) & " = " & lngTotal2 & "<br />"
			...
			Case 3
			    Response.Write "<td rowspan=""2"" class=""chart3_totals_right"">" & _
				    ...
				    m_lngBarImageWidth & """ height=""" & m_lngBarImageWidth & """ alt=""""  />&nbsp;" & m_arrLegendText(2) & " = " & lngTotal3 & "<br />"
...
'---------------------------- Should we print labels for the bars?
    ...
    If IsSafeArray(m_arrLabels) Then
		...
		For i = 0 To iMax
			iTmp1 = m_arrLabels(i)
			Response.Write "" & "<td class=""chart3_labels"">" & iTmp1 & "</td>"
		Next
...
'---------------------------- Should we print a footer text?
    ...
    If Len(m_sFooterText) > 0 Then Response.Write "<tr><td colspan=""" & (iMax + 4) & """ class=""chart3_footer"">" & m_sFooterText & "</td></tr>"

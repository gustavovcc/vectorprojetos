<%
'============================================================
' MODULE:        cMultipleHorizontalChart.asp
' AUTHOR:        www.u229.no
' CREATED:      June 2005
' HOME PAGE:   http://www.u229.no/stuff/HTMLGraph/
'============================================================
' COMMENT: This class will produce horizontal multiple bar charts using Classic ASP.
...
Class cMultipleHorizontalChart
...
Private m_lngTotal1                            '// Total sum of bar values
Private m_lngTotal2                            '// Total sum of bar values
Private m_lngTotal3                            '// Total sum of bar values
...
'---------------------------- Validate user input
    ...
    Response.Write "<table border=""0"" cellspacing=""0"" cellpadding=""0"" width="""" id=""chart5_table"">"
	If Len(m_sTableCaption) > 0 Then Response.Write "<caption>" & m_sTableCaption  & "</caption>"
	Response.Write "<tr><td colspan= ""2"" class=""chart5_title"">" & m_sChartTitle & "</td></tr>"
	Response.Write "<tr><td colspan= ""2"" class=""chart5_spacer_top"">&nbsp;</td></tr>"
    ...
    For i = 0 To iMax
		...
		Select Case m_lngArrayCounter
			...
			Case 2
				...
				m_lngTotal1 = (m_lngTotal1 + iTmp1)
				m_lngTotal2 = (m_lngTotal2 + iTmp2)
				
				Response.Write "<tr><td class=""chart5_labels"">" & m_arrLabels(i) & "</td>"
				Response.Write "<td class=""chart5_barcell"">"
				...
				If m_lngBarValueMode = 1 Then Response.Write "&nbsp;" & iTmp1 & "<br />"
				Response.Write "<br /><img src=""" & m_arrBarImages(1) & """ width=""" & iShrinked2 & """ height=""" & _
				    m_lngBarImageHeight & """ alt="""" title=""" & iTmp2 & """ />"
				If m_lngBarValueMode = 1 Then Response.Write "&nbsp;" & iTmp2
			...
			Case 3
				...
				Response.Write "<br /><img src=""" & m_arrBarImages(1) & """ width=""" & iShrinked2 & """ height=""" & _
				    m_lngBarImageHeight & """ alt="""" title=""" & iTmp2 & """ />"
				If m_lngBarValueMode = 1 Then Response.Write "&nbsp;" & iTmp2 & "<br />"
				Response.Write "<br /><img src=""" & m_arrBarImages(2) & """ width=""" & iShrinked3 & """ height=""" & _
				    m_lngBarImageHeight & """ alt="""" title=""" & iTmp3 & """ />"
				If m_lngBarValueMode = 1 Then Response.Write "&nbsp;" & iTmp3
...
'---------------------------- Print Totals at the bottom of the chart?
    ...
    If m_lngTotalsMode = 1 Then
	    ...
	    Select Case m_lngArrayCounter
	        Case 2
			    Response.Write "<tr><td colspan=""3"" class=""chart5_totals_bottom"">" & _
				    "<img src=""" & m_arrBarImages(0) & """ width=""" & _
				    m_lngBarImageHeight & """ height=""" & m_lngBarImageHeight & """ alt=""""  />&nbsp;" & m_arrLegendText(0) & " = " & m_lngTotal1 & _
				    "&nbsp;&nbsp;&nbsp;<img src=""" & m_arrBarImages(1) & """ width=""" & _
				    m_lngBarImageHeight & """ height=""" & m_lngBarImageHeight & """ alt=""""  />&nbsp;" & m_arrLegendText(1) & " = " & m_lngTotal2 & "</td></tr>"
			...
			Case 3
			    Response.Write "<tr><td colspan=""3"" class=""chart5_totals_bottom"">" & _
				    ...
				    m_lngBarImageHeight & """ height=""" & m_lngBarImageHeight & """ alt=""""  />&nbsp;" & m_arrLegendText(0) & " = " & m_lngTotal1 & _
				    "&nbsp;&nbsp;&nbsp;<img src=""" & m_arrBarImages(1) & """ width=""" & _
				    m_lngBarImageHeight & """ height=""" & m_lngBarImageHeight & """ alt=""""  />&nbsp;" & m_arrLegendText(1) & " = " & m_lngTotal2 & _
				    "&nbsp;&nbsp;&nbsp;<img src=""" & m_arrBarImages(2) & """ width=""" & _
				    m_lngBarImageHeight & """ height=""" & m_lngBarImageHeight & """ alt=""""  />&nbsp;" & m_arrLegendText(2) & " = " & m_lngTotal3 & "</td></tr>"
...
'---------------------------- Should we print a footer text?
    If Len(m_sFooterText) > 0 Then Response.Write "<tr><td colspan=""3"" class=""chart5_footer"">" & m_sFooterText & "</td></tr>"
